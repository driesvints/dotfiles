...
defaults write NSGlobalDomain NSTableViewDefaultSizeMode -int 5
...
# Set the computer to sleep after 10 minutes
sudo systemsetup -setcomputersleep 10

# Set the speed of delete key
defaults write NSGlobalDomain KeyRepeat -int 2

# Set the delay before repeat key (e.g., before deleting)
defaults write NSGlobalDomain InitialKeyRepeat -int 35

# Check for software updates daily, not just once per week
# defaults write com.apple.SoftwareUpdate ScheduleFrequency -int 1 NOTE: don't turn on for Hackintosh
...
# I commented out these ones because removing sleepimage is hard
...
# I commented because I couldn't write to universalaccess
...
# I commented because I couldn't get it working
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" \
    ...
    "SystemUIServer" "Twitter" "iCal"; do
