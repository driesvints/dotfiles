...
This is a fork of [Dries Vint's dotfiles](https://github.com/driesvints/dotfiles). Make sure to take a look at his GitHub repo if you wanna start with yours.
...
2. Setup an SSH key by using one of the two following methods  
   ...
   ```zsh
   curl https://raw.githubusercontent.com/filippofortino/dotfiles/HEAD/ssh.sh | sh -s "<your-email-address>"
   ```

3. Clone this repo to `~/.dotfiles` with:

    ```zsh
    git clone --recursive git@github.com:filippofortino/dotfiles.git ~/.dotfiles
    ```
