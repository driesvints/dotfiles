...
2. [Generate a new public and private SSH key](https://docs.github.com/en/github/authenticating-to-github/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) and add them to Github by running `ssh.sh` and following the instructions

   ```zsh
   curl https://raw.githubusercontent.com/driesvints/dotfiles/HEAD/ssh.sh | bash
   ```

3. Clone this repo with `git clone git@github.com:driesvints/dotfiles.git ~/.dotfiles`
